                                ...
                                return (
                                    <div key={index} className="relative">
                                        <button
                                            ...
                                            className={`relative w-full aspect-[3/4] flex items-center justify-center bg-white dark:bg-slate-700 border-2 rounded-lg font-bold text-xs sm:text-lg leading-none whitespace-nowrap overflow-hidden transition-all shadow-sm group
                                                ${isWinner
                                    ...
                                    {category.tiles.map((tile, index) => (
                                        <div key={index} className="relative group">
                                            <button
                                                ...
                                                className={`w-full aspect-[3/4] flex items-center justify-center bg-slate-100 dark:bg-slate-800 border-2 rounded-lg font-bold text-xs sm:text-lg leading-none whitespace-nowrap overflow-hidden transition-all shadow-sm ${handTiles.length >= 17 || handTiles.filter(t => t.suit === tile.suit && t.value === tile.value).length >= 4 ? 'border-slate-200 opacity-30 cursor-not-allowed' : 'border-slate-300 dark:border-slate-600 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 hover:border-indigo-400 dark:hover:border-indigo-600'
                                                    }`}
                                            >
                                                {tile.displayChar}
                                            </button>
