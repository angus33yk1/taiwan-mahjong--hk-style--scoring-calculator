...
export const SCORING_DATA: ScoringItem[] = [
  ...
  { id: 'e-6', name: '七只內', nameEn: 'Seven Tiles Hand', fan: 20, description: '玩家打出的牌少於7張', descriptionEn: 'Hand contains 7 or fewer tiles', category: ScoringCategory.SPECIAL_EVENTS },
  { id: 'e-7', name: '十只內', nameEn: 'Ten Tiles Hand', fan: 10, description: '玩家打出的牌少於10張', descriptionEn: 'Hand contains 10 or fewer tiles', category: ScoringCategory.SPECIAL_EVENTS },
